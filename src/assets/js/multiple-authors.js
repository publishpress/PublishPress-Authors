...
jQuery(document).ready(
    function ($) {
            ...
            "click", ".editinline", function () {
                ...
                var timeoutFn = setTimeout(
                    function () {
                        ...
                        authorsListSelector.find("li").each(
                            function () {
                                var displayName = $(this)
                                .find(".display-name")
                                .text()
                                .trim();
                                if (!authorsSlugs.includes(displayName) 
        ...
        {
            selector.sortable().on(
                "click", ".author-remove", function () {
                    var el = $(this);
        ...
        $(".authors-select2-user-select").each(
            function () {
                $(this).ppma_select2(
                    {
                        allowClear: true,
        ...
        $(".author-image-field-wrapper").each(
            function () {
                var frame,
        ...
        if ((window.location.pathname === "/wp-admin/edit-tags.php" 
