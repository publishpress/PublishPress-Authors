...
class CMB2_Types
{
    ...
    public function __call($fieldtype, $arguments)
    {
         ...
         */
        do_action("cmb2_render_{$fieldtype}", $this->field, $this->field->escaped_value(), $this->field->object_id,
            $this->field->object_type, $this);
    }
     ...
     */
    protected function proxy_method($method, $default, $args = [])
    {
     ...
     */
    public function maybe_custom_field_object($fieldtype, $args = [])
    {
     ...
     */
    public function get_new_render_type($fieldtype, $render_class_name = null, $args = [], $additional = '')
    {
    ...
    public function render_repeatable_field()
    {
        ...
        <p class="cmb-add-row">
            <button type="button" data-selector="<?php echo $table_id; ?>"
                    class="cmb-add-row-button button-secondary"><?php echo esc_html($this->_text('add_row_text',
    ...
    protected function repeat_row($class = 'cmb-repeat-row')
    {
        ...
        <div class="cmb-row <?php echo $class; ?>">
            ...
            <div class="cmb-td cmb-remove-row">
                <button type="button" class="button-secondary cmb-remove-row-button"
                        title="<?php echo esc_attr($this->_text('remove_row_button_title',
                            esc_html__('Remove Row', 'cmb2'))); ?>"><?php echo esc_html($this->_text('remove_row_text',
     ...
     */
    public function input($args = [], $type = __FUNCTION__)
    {
    ...
    {
        return $this->get_new_render_type(__FUNCTION__, 'CMB2_Type_Text', [
    ...
    {
        $input = $this->get_new_render_type(__FUNCTION__, 'CMB2_Type_Text', [
    ...
    {
        return $this->get_new_render_type(__FUNCTION__, 'CMB2_Type_Textarea', [
    ...
    public function buttonsgroup($args = [])
    {
        return $this->get_new_render_type(__FUNCTION__, 'CMB2_Type_ButtonsGroup', $args)->render();
    }
    ...
    {
        return $this->get_new_render_type(__FUNCTION__, 'CMB2_Type_Multicheck', [], $type)->render();
    }
    ...
    public function checkbox($args = [], $is_checked = null)
    {
    ...
    public function file_list($args = [])
    {
