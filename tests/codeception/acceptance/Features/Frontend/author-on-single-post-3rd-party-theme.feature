Feature: Display author on single post page for 3rd party theme
    ...
    Scenario: I see the name of the guest author in the byline added by the theme "Twenty Twenty-One"
        Given guest author exists with name "AOS Guest Author 1" and slug "aos_guest_author_1"
        And a post named "aos_post_guest_author_1" exists for "aos_guest_author_1"
        When I view the post "aos_post_guest_author_1"
        Then I see the author name "AOS Guest Author 1" in the byline

    Scenario: I see the link for the guest author in the byline added by the theme "Twenty Twenty-One"
        Given guest author exists with name "AOS Guest Author 2" and slug "aos_guest_author_2"
        And a post named "aos_post_guest_author_2" exists for "aos_guest_author_2"
        When I view the post "aos_post_guest_author_2"
        Then I see the link for author "aos_guest_author_2" in the byline
